...
{
    /// <summary>
    /// This is an implementation from MSFT but had extra code 
    /// than can/should be trimmed before finalization
    ...
    public class JWK
    {
        ...
        /// <summary>
        /// Gets or sets supported JWK key types (kty) for Elliptic
        ...
        /// <summary>
        /// Creates an instance of <see cref="JWK"/>
        /// </summary>
        [JsonConstructor]
        public JWK()
        {
        ...
        /// <returns></returns>
        public JWK(Aes aesProvider)
        {
            if (aesProvider == null)
                throw new ArgumentNullException("aesProvider");

            Kty = JsonWebKey.KeyType.Octet;
            K = aesProvider.Key;
        }
        ...
        public JWK(RSA rsaProvider, bool includePrivateParameters = false) : this(rsaProvider.ExportParameters(includePrivateParameters))
        {
        }
        ...
        /// <returns>A WebKey representing the RSA object</returns>
        public JWK(RSAParameters rsaParameters)
        {
            Kty = JsonWebKey.KeyType.Rsa;
        ...
        public override int GetHashCode()
        {
            ...
            switch (Kty)
            {
                case JsonWebKey.KeyType.Octet:
                    return hashCode += GetHashCode(K);

                case JsonWebKey.KeyType.Rsa:
        ...
        public virtual bool IsValid()
        {
            ...
            {
                if (!KeyOps.All((op) => { return JsonWebKey.Operation.AllOperations.Contains(op); }))
                    return false;
            }
            ...
            switch (Kty)
            {
                case JsonWebKey.KeyType.EllipticCurve:
                    break;
        ...
        public Aes ToAes()
        {
            if (!Kty.Equals(JsonWebKey.KeyType.Octet))
        ...
        {
            if (!string.Equals(JsonWebKey.KeyType.Rsa, Kty))
        ...
        public void ClearMemory()
        {
            ...
            switch (Kty)
            {
                ...
                default:
                    ...
                    // Note that although there is JsonWebKey.Type.EllipticCurve, it's not supported yet.
